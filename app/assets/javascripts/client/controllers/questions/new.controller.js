(function () {
	...
	angular.module('comuniapp').controller('QuestionsNewController', ['$scope', '$mdToast', '$state', '$stateParams', 'QuestionService', function ($scope, $mdToast, $state, $stateParams, QuestionService) {
